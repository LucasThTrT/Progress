...
import 'package:progress_version_alpha/Services/getColorFromHex.dart';

// pour trouver l'image dans le fichier a supprimer dans le futur
// import 'dart:io';

class MyUserCardContents extends StatelessWidget {

  final dynamic jsonObject;
  
  const MyUserCardContents({super.key, required this.jsonObject});
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        // Image de profil
                        Container(
                          width: 10.0, // Width of the container
